...
class ScheduleAction extends AbstractController {
    ...
    public function saveSchedule(Request $request, ?string $scheduleId = null): JsonResponse
    {
        ...
        try{
            ...
            $this->controllers->getScheduleController()->saveSchedule($schedule);
    ...
    public function getAllNotDeletedSchedules(): JsonResponse
    {
        ...
        try{
            $schedulesDtoJsons = [];
            $schedules         = $this->controllers->getScheduleController()->getAllNotDeletedSchedules();
