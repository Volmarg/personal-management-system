...
class MyContactsSettingsController extends AbstractController {
    ...
    const TWIG_TEMPLATE_SETTINGS            = 'modules/my-contacts-2/settings.html.twig';
    const TWIG_TEMPLATE_CONTACT_TYPES_TABLE = 'modules/my-contacts-2/components/settings/types-settings.table.html.twig';
    ...
    /* TODO: add new type field: image - which on edit turns into link and back + add column image?*/
