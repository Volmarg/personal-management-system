...
class EncryptUploadFilesCommand extends EncryptionCommand
{
    protected static $defaultName = 'pms:files:encrypt-upload-files';
        ...
        $this->io->success("Started");
        {
            try{
                ...
                foreach($filesList as $fileAbsolutePath){
                    ...
                    $this->encryptionService->encryptFile($fileAbsolutePath);
                    $progressBar->advance();
                }
