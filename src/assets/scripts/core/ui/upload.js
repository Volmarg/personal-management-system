...
export default (function () {
    ...
    ui.upload = {
        ...
        elements: {
          ...
          currentUploadedFilesCountWrapper: '',
        },
        attributes:{
        ...
        settings: {
            addConfirmationBoxesToForms: function(){
                let _this = this;
                let submitButtons = [
                    ui.upload.selectors.id.settings.createSubdirectorySubmit,
                    ui.upload.selectors.id.settings.subdirectoryMoveDataSubmit,
                    ui.upload.selectors.id.settings.subdirectoryRenameSubmit,
                ];
