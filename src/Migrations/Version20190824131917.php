...
final class Version20190824131917 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE my_job_afterhours CHANGE date date VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE my_car CHANGE date date VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql("UPDATE my_car SET `date` = DATE_FORMAT(`date`,'%d-%m-%Y')");

        $this->addSql('ALTER TABLE my_goals_payments CHANGE deadline deadline VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE my_goals_payments CHANGE collection_start_date collection_start_date VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
